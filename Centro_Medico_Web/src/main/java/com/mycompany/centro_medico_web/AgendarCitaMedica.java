 ...
 * @author lex
 */
@WebServlet(name = "AgendarCitaMedica", urlPatterns = {"/AgendarCitaMedica"})
public class AgendarCitaMedica extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet AgendarCitaMedica</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet AgendarCitaMedica at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            response.sendRedirect("Medico/ExitoCita.jsp");
