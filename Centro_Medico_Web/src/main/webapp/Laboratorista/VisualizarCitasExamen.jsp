      ...
      %>
         <section class="contenidoLex">
             <form action="VisualizarCitasExamen.jsp" method="POST">
                  <h2 class="titleLex">Generar informe de examen</h2><br>
                 <div class="wrap">
                             ...
                             if(campo!=null){
                                 ...
                                 while (rs.next()){ %>
                                        <tr>
                                            ...
                                            <td>
                                                <a class="btn btn-warning btn-sm" href="GenerarInformeExamen.jsp?codigo=<%=rs.getString("codigo")%>" name="">Generar informe.</a>
                                            </td>
                                        </tr>
                                    <% } 
