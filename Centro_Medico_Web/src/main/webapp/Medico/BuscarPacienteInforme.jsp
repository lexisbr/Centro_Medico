...
<html>
   <!--Encabezado-->
      ...
      <section class="contenidoLex">
          <form action="BuscarPacienteInforme.jsp" method="POST">
               <h2 class="titleLex">Visualizar historial medico</h2><br>
              <div class="wrap">
              ...
              <div class="container">
                  <table class="table table-dark table-bordered">
                      ...
                      <tr>
                          ...
                          <td>
                              <a class="btn btn-warning btn-sm" href="HistorialMedico.jsp?codigo_paciente=<%=rs.getString("codigo")%>">Visualizar historial medico</a>
                          </td>
                      </tr>
                      <%
