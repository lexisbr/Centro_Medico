...
<html>
      ...
      <section class="contenidoLex">
          <div class="container">
              ...
              <hr>
              <div class="centrar">
                  <form action="" method="post" class="form-control" style="width: 500px; height: 550px; background: #ccccff;">
                      <div class="form-group">
                          <input type="text" name="nombre_examen" class="form-control" placeholder="Nombre de examen"/>
                      </div>
                      ...
                      <div class="form-group">
                          <textarea name="descripcion" class="textarea" rows="5" cols="40" style="width: 100%;" placeholder="Descripcion"></textarea>
                      </div>
                      <div class="form-group">
                          <input type="number" name="costo"  step="0.01" min="0" class="form-control" placeholder="Costo"/>
                      </div>
                      <div class="form-group">
                          <input type="text" name="tipo_archivo" class="form-control" placeholder="Tipo de archivo (IMG o PDF)"/>
                      </div>
